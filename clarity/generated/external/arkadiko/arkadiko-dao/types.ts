...
export interface ArkadikoDaoContract {
  ...
  getEmergencyShutdownActivated: () => Promise<
    ClarityTypes.Response<boolean, null>
  >;
  ...
  contracts: (key: { name: string }) => Promise<{
    address: string;
    "qualified-name": string;
  } | null>;
  contractsData: (key: { "qualified-name": string }) => Promise<{
    "can-burn": boolean;
    "can-mint": boolean;
  } | null>;
}
