...
export interface BtcNftSwapContract {
  ...
  createSwap: (sats: number | bigint, btcReceiver: Buffer, nftId: number | bigint, nftReceiver: string, nft: string) => Transaction<bigint, bigint>;
  getOutValue: (tx: {
  "ins": {
  "outpoint": {
  "hash": Buffer;
  ...
  "tree-depth": bigint;
  "tx-index": bigint
    }, nft: string) => Transaction<boolean, bigint>;
