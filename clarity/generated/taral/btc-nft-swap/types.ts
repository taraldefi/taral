...
export interface BtcNftSwapContract {
    cancel: (id: number, nft: string, metadata: IMetadata) => Transaction<boolean, number>;
    createSwap: (sats: number, btcReceiver: Buffer, nftId: number, nftReceiver: string, nft: string, metadata: IMetadata) => Transaction<number, number>;
    getOutValue: (tx: {
        "ins": {
            "outpoint": {
                "hash": Buffer;
    ...
    submitSwap: (id: number, block: {
        ...
        "tree-depth": number;
        "tx-index": number
    }, nft: string, metadata: IMetadata) => Transaction<boolean, number>;
