...
RUN \
    ...
    NEXT_PUBLIC_TARAL_LENDER_TESTNET_ADDRESS=APP_NEXT_PUBLIC_TARAL_LENDER_TESTNET_ADDRESS \
    NEXT_PUBLIC_SUSDT_TESTNET_CONTRACT=APP_NEXT_PUBLIC_SUSDT_TESTNET_CONTRACT \
    NEXT_PUBLIC_TARAL_BANK_TESTNET_CONTRACT=APP_NEXT_PUBLIC_TARAL_BANK_TESTNET_CONTRACT \
    yarn build
