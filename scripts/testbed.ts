...
import { cvToString, bufferCV, callReadOnlyFunction, listCV, tupleCV, ReadOnlyFunctionOptions, makeContractCall } from "@stacks/transactions";
...
async function testSwap() {
  ...
  const swapId = await createBtcFtSwap({
    ...
    ftSellerBitcoinAddress: ALICE_BTC,
    ftBuyerStacksAddress: BOB_STX,
  });
