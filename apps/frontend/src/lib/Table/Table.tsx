...
export const RepaymentTable: React.FC<repaymentTableType> = ({
	...
	<div className='table'>
		<table>
			<tbody>
				<tr>
					{['Payment', 'Amount', 'Due Date', 'status'].map(
						(item, index) => {
							return <th key={index}>{item}</th>;
						},
					)}
		...
		<table>
			<tbody>
				...
				{entityTableData.map((item, index) => {
					return (
						<tr key={index}>
							<td className='persons--tab'>
								{item.productTitle}
							</td>
							<td className='details--tab'>
								{item.issuanceDate}
							</td>
	...
	<div className='table'>
		<table>
			<tbody>
				<tr>
					{/* <div className="statusTitle"> */}
					{['Persons', 'Hit', 'Source', 'Options'].map(
						(item, index) => {
							return <th key={index}>{item}</th>;
						},
					)}
...
export const SignOffTable: React.FC<signOffTableType> = ({
	...
	<div className='table'>
		<table>
			<tbody>
				<tr>
					{['Name', 'Position', 'Status', 'Status'].map(
						(item, index) => {
							return <th key={index}>{item}</th>;
						},
					)}
					...
					return (
						<tr key={index}>
							...
							<td className='image--container'>
								{overviewTableData[index].users.map(
									(item, index) => {
										return (
											<img
												className='images'
...
export const QuantitativeTable: React.FC<quantitativeTableType> = ({
	...
	<div className='table'>
		<table>
			<tbody>
				<tr>
					{['Factor', 'Value', 'Status', 'Metric'].map(
						(item, index) => {
							return <th key={index}>{item}</th>;
						},
					)}
		...
		<>
			...
			<div className='table'>
				<table>
					<tbody>
						<tr>
							{['Assignee', 'Task', 'Assignor', 'Date'].map(
								(item, index) => {
									return <th key={index}>{item}</th>;
								},
							)}
