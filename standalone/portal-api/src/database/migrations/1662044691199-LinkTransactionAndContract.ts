...
export class LinkTransactionAndContract1662044691199 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "Transactions" ADD CONSTRAINT "UQ_e1accc56c67658990c6a1bfed8c" UNIQUE ("contractId")`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "Transactions" DROP CONSTRAINT "UQ_e1accc56c67658990c6a1bfed8c"`);
        await queryRunner.query(`ALTER TABLE "Transactions" DROP COLUMN "contractId"`);
