...
export class LinkSupplierFinancials1661877989648 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "Suppliers" ADD CONSTRAINT "UQ_fcc62eefa3e8f3ca06de68ecd72" UNIQUE ("financialsId")`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "Suppliers" DROP CONSTRAINT "UQ_fcc62eefa3e8f3ca06de68ecd72"`,
    );
    await queryRunner.query(
      `ALTER TABLE "Suppliers" DROP COLUMN "financialsId"`,
    );
  }
}
