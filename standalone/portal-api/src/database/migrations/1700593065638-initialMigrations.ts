...
export class initialMigrations1700593065638 implements MigrationInterface {
    name = 'initialMigrations1700593065638'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "QuickApplications" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "applicationNumber" character varying NOT NULL, "title" character varying NOT NULL, "issuanceDate" TIMESTAMP WITH TIME ZONE NOT NULL, "endDate" TIMESTAMP WITH TIME ZONE NOT NULL, "status" "public"."QuickApplications_status_enum" NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL, "type" character varying NOT NULL, "supplierInformationId" uuid, "paymentTermsId" uuid, "orderDetailsId" uuid, "securityId" uuid, "transactionDocumentsId" uuid, "companyId" uuid, CONSTRAINT "UQ_85c10210343cf46c064d81bd28e" UNIQUE ("applicationNumber"), CONSTRAINT "REL_9c7f5e3cd5c3cbc2ff1d2b172b" UNIQUE ("paymentTermsId"), CONSTRAINT "REL_9714c72d5f4bdbff1b3b1065ac" UNIQUE ("orderDetailsId"), CONSTRAINT "REL_42d992ef8ec8ab6d5bd3e482a5" UNIQUE ("securityId"), CONSTRAINT "REL_fc64ed251907a199aaa04b6e8f" UNIQUE ("transactionDocumentsId"), CONSTRAINT "PK_6f485ac97e0f3240b34a2054726" PRIMARY KEY ("id"))`);
