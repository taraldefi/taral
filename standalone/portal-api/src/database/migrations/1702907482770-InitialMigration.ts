...
export class InitialMigration1702907482770 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "CompanyInformation" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "employeeCount" integer, "type" character varying NOT NULL, "addressId" uuid, CONSTRAINT "REL_d4269c155a69922cd29f7eca09" UNIQUE ("addressId"), CONSTRAINT "PK_66bb02343b9cdb0a0729de4138d" PRIMARY KEY ("id"))`);
