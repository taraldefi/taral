...
export class LinkSupplierCompany1661877832389 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "Suppliers" ADD CONSTRAINT "UQ_a9f507ce81ecc3d58203f673fa3" UNIQUE ("companyId")`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "Suppliers" DROP CONSTRAINT "UQ_a9f507ce81ecc3d58203f673fa3"`,
    );
