...
export class CompanySupplierInheritance1661879046143 implements MigrationInterface {
    name = 'CompanySupplierInheritance1661879046143'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "Companies" ADD "type" character varying NOT NULL`);
