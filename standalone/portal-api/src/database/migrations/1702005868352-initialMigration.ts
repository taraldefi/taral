...
export class initialMigration1702005868352 implements MigrationInterface {
    name = 'initialMigration1702005868352'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "CompanyInformation" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "phoneNumber" character varying NOT NULL, "employeeCount" integer, "registrationNumbers" character varying NOT NULL, "type" character varying NOT NULL, "addressId" uuid, CONSTRAINT "REL_d4269c155a69922cd29f7eca09" UNIQUE ("addressId"), CONSTRAINT "PK_66bb02343b9cdb0a0729de4138d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "SupplierCompanyTaxAndRevenue" ADD CONSTRAINT "FK_d62129e190f3e09af585acb9d67" FOREIGN KEY ("supplierCompanyId") REFERENCES "SupplierCompanies"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "BuyerCompanyTaxAndRevenue" ADD CONSTRAINT "FK_5ad7c7c244a7d681a273157ddc3" FOREIGN KEY ("buyerCompanyId") REFERENCES "BuyerCompanies"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "BuyerCompanyTaxAndRevenue" DROP CONSTRAINT "FK_5ad7c7c244a7d681a273157ddc3"`);
        ...
        await queryRunner.query(`ALTER TABLE "SupplierCompanyTaxAndRevenue" DROP CONSTRAINT "FK_d62129e190f3e09af585acb9d67"`);
