...
export class initialMigrations1701438511057 implements MigrationInterface {
    name = 'initialMigrations1701438511057'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "TaxAndRevenue" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "taxNumber" character varying, "lastFiscalYear" integer NOT NULL, "totalRevenue" character varying NOT NULL, "exportValue" integer, "audited" boolean, "exportRevenuePercentage" numeric(10,2) DEFAULT '0', "companyId" uuid, CONSTRAINT "UQ_27cfd3b53a3c6a3927d36b2ed88" UNIQUE ("lastFiscalYear"), CONSTRAINT "PK_2be7e0740a6231261a5cc7883b6" PRIMARY KEY ("id"))`);
