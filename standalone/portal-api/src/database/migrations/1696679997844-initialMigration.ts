...
export class initialMigration1696679997844 implements MigrationInterface {
    name = 'initialMigration1696679997844'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Buyer_Quick_Applications" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "issuanceDate" TIMESTAMP WITH TIME ZONE NOT NULL, "status" "public"."Buyer_Quick_Applications_status_enum" NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL, "buyerInformationId" uuid, "supplierInformationId" uuid, "paymentTermsId" uuid, "securityId" uuid, "transactionDocumentsId" uuid, "legalEntityId" uuid, "relationshipWithSuppplierId" uuid, "orderDetailsId" uuid, CONSTRAINT "REL_a8a262d88e97c0be49cf585417" UNIQUE ("buyerInformationId"), CONSTRAINT "REL_65314bce28c85057662b972406" UNIQUE ("supplierInformationId"), CONSTRAINT "REL_926038ea13b423a50854dc4897" UNIQUE ("paymentTermsId"), CONSTRAINT "REL_f1e1ae09ce585896937b84356e" UNIQUE ("securityId"), CONSTRAINT "REL_56861eca0f67481bc2dbbf5f1f" UNIQUE ("transactionDocumentsId"), CONSTRAINT "REL_3ef3e5f59bff987cd6ffd61dc1" UNIQUE ("relationshipWithSuppplierId"), CONSTRAINT "REL_c9b7e2218ce1c4d104f271c11b" UNIQUE ("orderDetailsId"), CONSTRAINT "PK_568d688d7ed95c3bdc9f644fa8f" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "Buyer_Quick_Applications" ADD CONSTRAINT "FK_a5b2f14c308eddb2b9d08bea9fc" FOREIGN KEY ("legalEntityId") REFERENCES "legal-entity"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "Buyer_Quick_Applications" ADD CONSTRAINT "FK_3ef3e5f59bff987cd6ffd61dc13" FOREIGN KEY ("relationshipWithSuppplierId") REFERENCES "CollaborationRelationships"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "Supplier_Quick_Applications" ADD CONSTRAINT "FK_8a15cfd67e42cbf77b20dc09c6e" FOREIGN KEY ("legalEntityId") REFERENCES "legal-entity"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "Buyer_Quick_Applications" DROP CONSTRAINT "FK_3ef3e5f59bff987cd6ffd61dc13"`);
