...
export class initialMigration1702540704852 implements MigrationInterface {
    name = 'initialMigration1702540704852'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "TransactionDocuments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "confirmationDocument" boolean, "additionalDocument" boolean, CONSTRAINT "PK_8488f8e87bde7dacf065cec4cbb" PRIMARY KEY ("id"))`);
