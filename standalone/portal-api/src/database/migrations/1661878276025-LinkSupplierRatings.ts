...
export class LinkSupplierRatings1661878276025 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "Suppliers" ADD CONSTRAINT "UQ_141b8ecc6c046ae0f68c9b8bb5f" UNIQUE ("ratingId")`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "Suppliers" DROP CONSTRAINT "UQ_141b8ecc6c046ae0f68c9b8bb5f"`);
