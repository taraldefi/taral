...
export class Auctions1690611634899 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "permission" ALTER COLUMN "createdAt" TYPE TIMESTAMP(3)`);
        await queryRunner.query(`ALTER TABLE "permission" ALTER COLUMN "createdAt" SET DEFAULT ('now'::text)::timestamp(3) with time zone`);
        await queryRunner.query(`ALTER TABLE "permission" ALTER COLUMN "updatedAt" TYPE TIMESTAMP(3)`);
        await queryRunner.query(`ALTER TABLE "permission" ALTER COLUMN "updatedAt" SET DEFAULT ('now'::text)::timestamp(3) with time zone`);
        await queryRunner.query(`ALTER TABLE "rolea" ALTER COLUMN "createdAt" TYPE TIMESTAMP(3)`);
        await queryRunner.query(`ALTER TABLE "rolea" ALTER COLUMN "createdAt" SET DEFAULT ('now'::text)::timestamp(3) with time zone`);
        await queryRunner.query(`ALTER TABLE "rolea" ALTER COLUMN "updatedAt" TYPE TIMESTAMP(3)`);
        await queryRunner.query(`ALTER TABLE "rolea" ALTER COLUMN "updatedAt" SET DEFAULT ('now'::text)::timestamp(3) with time zone`);
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "createdAt" TYPE TIMESTAMP(3)`);
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "createdAt" SET DEFAULT ('now'::text)::timestamp(3) with time zone`);
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "updatedAt" TYPE TIMESTAMP(3)`);
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "updatedAt" SET DEFAULT ('now'::text)::timestamp(3) with time zone`);
        await queryRunner.query(`ALTER TABLE "email_templates" ALTER COLUMN "createdAt" TYPE TIMESTAMP(3)`);
        await queryRunner.query(`ALTER TABLE "email_templates" ALTER COLUMN "createdAt" SET DEFAULT ('now'::text)::timestamp(3) with time zone`);
        await queryRunner.query(`ALTER TABLE "email_templates" ALTER COLUMN "updatedAt" TYPE TIMESTAMP(3)`);
        await queryRunner.query(`ALTER TABLE "email_templates" ALTER COLUMN "updatedAt" SET DEFAULT ('now'::text)::timestamp(3) with time zone`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "email_templates" ALTER COLUMN "updatedAt" SET DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "email_templates" ALTER COLUMN "updatedAt" TYPE TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE "email_templates" ALTER COLUMN "createdAt" SET DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "email_templates" ALTER COLUMN "createdAt" TYPE TIMESTAMP(6)`);
        ...
        await queryRunner.query(`ALTER TABLE "rolea" ALTER COLUMN "updatedAt" SET DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "rolea" ALTER COLUMN "updatedAt" TYPE TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE "rolea" ALTER COLUMN "createdAt" SET DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "rolea" ALTER COLUMN "createdAt" TYPE TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE "permission" ALTER COLUMN "updatedAt" SET DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "permission" ALTER COLUMN "updatedAt" TYPE TIMESTAMP(6)`);
        await queryRunner.query(`ALTER TABLE "permission" ALTER COLUMN "createdAt" SET DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "permission" ALTER COLUMN "createdAt" TYPE TIMESTAMP(6)`);
