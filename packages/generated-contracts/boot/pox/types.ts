  ...
  export interface PoxContract {
      allowContractCaller: (caller: string, untilBurnHt: bigint | null) => Transaction<boolean, bigint>;
  delegateStackStx: (stacker: string, amountUstx: number | bigint, poxAddr: {
  "hashbytes": Buffer;
  "version": Buffer
    }, startBurnHt: number | bigint, lockPeriod: number | bigint) => Transaction<{
  "lock-amount": bigint;
  "stacker": string;
  "unlock-burn-height": bigint
    }, bigint>;
  delegateStx: (amountUstx: number | bigint, delegateTo: string, untilBurnHt: bigint | null, poxAddr: {
  "hashbytes": Buffer;
  "version": Buffer
    } | null) => Transaction<boolean, bigint>;
  ...
  setBurnchainParameters: (firstBurnHeight: number | bigint, prepareCycleLength: number | bigint, rewardCycleLength: number | bigint, rejectionFraction: number | bigint) => Transaction<boolean, bigint>;
  stackAggregationCommit: (poxAddr: {
  "hashbytes": Buffer;
  "version": Buffer
    }, rewardCycle: number | bigint) => Transaction<boolean, bigint>;
  stackStx: (amountUstx: number | bigint, poxAddr: {
  "hashbytes": Buffer;
  "version": Buffer
    }, startBurnHt: number | bigint, lockPeriod: number | bigint) => Transaction<{
  "lock-amount": bigint;
  ...
  "hashbytes": Buffer;
  "version": Buffer
    }, amountUstx: number | bigint, firstRewardCycle: number | bigint, numCycles: number | bigint) => Promise<ClarityTypes.Response<boolean, bigint>>;
  ...
  getPoxRejection: (stacker: string, rewardCycle: number | bigint) => Promise<{
  "amount": bigint
    } | null>;
  getRewardSetPoxAddress: (rewardCycle: number | bigint, index: number | bigint) => Promise<{
  "pox-addr": {
  "hashbytes": Buffer;
  "version": Buffer
    };
