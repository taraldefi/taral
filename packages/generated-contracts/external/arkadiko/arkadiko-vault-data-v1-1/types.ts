...
export interface ArkadikoVaultDataV11Contract {
  ...
  closingVault: (key: { user: string }) => Promise<{
    "vault-id": bigint;
  } | null>;
  stackingPayout: (key: {
    "lot-index": bigint;
  ...
  stackingPayoutLots: (key: { "vault-id": bigint }) => Promise<{
    ids: bigint[];
  } | null>;
  vaultEntries: (key: { user: string }) => Promise<{
    ids: bigint[];
  } | null>;
  vaults: (key: { id: bigint }) => Promise<{
    "auction-ended": boolean;
    "auto-payoff": boolean;
    collateral: bigint;
    "collateral-token": string;
