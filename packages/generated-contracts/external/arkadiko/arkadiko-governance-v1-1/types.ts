...
export interface ArkadikoGovernanceV11Contract {
  ...
  proposals: (key: { id: bigint }) => Promise<{
    "contract-changes": {
      address: string;
      "can-burn": boolean;
      "can-mint": boolean;
  ...
  votesByMember: (key: { member: string; "proposal-id": bigint }) => Promise<{
    "vote-count": bigint;
  } | null>;
}
