...
describe("Should test insurance audit flows", () => {
  it("Should ensure that invalid txs are not accepted", () => {
    ...
    const getTxValueForPoolCompactResult = simnet.callReadOnlyFn(
      ...
      [
        Cl.bufferFromHex(
          "",
        ),
      ],
      WALLET_1,
    );
    ...
    if (VERBOSE) {
      console.log(
        "Get Tx Value For Pool Compact Result:",
        JSON.stringify(getTxValueForPoolCompactResult, null, 2),
      );
    }
    ...
    it("Should ensure that valid txs report the correct amount", () => {
      ...
      const validTransactionModel = Cl.tuple({
        ...
        outs: Cl.list([
          ...
          Cl.tuple({
            scriptPubKey: Cl.bufferFromHex(
              "76a9146d78de7b0625dfbfc16c3a8a5735f6dc3dc3f2ce88ac",
            ),
