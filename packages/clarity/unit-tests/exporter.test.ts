...
describe("Should test exporter flows", () => {
  it("Should ensure that inputs are valid", () => {
    ...
    if (VERBOSE) {
      console.log(
        "Register Exporter Result:",
        JSON.stringify(registerExporterResult, null, 2),
      );
    }
    ...
    it("Should ensure that exporter exists after registration", () => {
      ...
      if (VERBOSE) {
        console.log(
          "Get Exporter Result:",
          JSON.stringify(getExporterResult.result, null, 2),
        );
      }
    ...
    it("Should ensure that order inputs are valid", () => {
      ...
      if (VERBOSE) {
        console.log(
          "Append Order Result:",
          JSON.stringify(appendOrderResult, null, 2),
        );
      }
  ...
  it("Should ensure that adding order is a success", () => {
    ...
    it("Should ensure that order exists after registration", () => {
      ...
      if (VERBOSE) {
        console.log(
          "Get Exporter Order Result:",
          JSON.stringify(getExporterOrderResult.result, null, 2),
        );
      }
