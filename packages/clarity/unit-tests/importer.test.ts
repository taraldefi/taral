...
describe("Should test importer flows", () => {
  it("Should ensure that inputs are valid", () => {
    ...
    if (VERBOSE) {
      console.log(
        "Register importer Result:",
        JSON.stringify(registerImporterResult, null, 2),
      );
    }
    ...
    it("Should ensure that importer exists after registration", () => {
      ...
      if (VERBOSE) {
        console.log(
          "Get Importer Result:",
          JSON.stringify(getImporterResult.result, null, 2),
        );
      }
    ...
    it("Should ensure that order exists after registration", () => {
      ...
      if (VERBOSE) {
        console.log(
          "Get importer Order Result:",
          JSON.stringify(getimporterOrderResult.result, null, 2),
        );
      }
