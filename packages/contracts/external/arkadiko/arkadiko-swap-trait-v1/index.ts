  ...
  export const nodeArkadikoSwapTraitV1Contract = (provider: BaseNodeProvider) => {
    const contract = nodeProxy<ArkadikoSwapTraitV1Contract>(ArkadikoSwapTraitV1Interface, provider);
    return contract;
  };
  ...
  export const webArkadikoSwapTraitV1Contract = (provider: BaseWebProvider) => {
    const contract = webProxy<ArkadikoSwapTraitV1Contract>(ArkadikoSwapTraitV1Interface, provider);
    return contract;
  };
