  ...
  export const nodeArkadikoStackerV11Contract = (provider: BaseNodeProvider) => {
    const contract = nodeProxy<ArkadikoStackerV11Contract>(ArkadikoStackerV11Interface, provider);
    return contract;
  };
  ...
  export const webArkadikoStackerV11Contract = (provider: BaseWebProvider) => {
    const contract = webProxy<ArkadikoStackerV11Contract>(ArkadikoStackerV11Interface, provider);
    return contract;
  };
