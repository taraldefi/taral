...
export const nodeArkadikoDikoGuardianV11Contract = (
    provider: BaseNodeProvider
) => {
    const contract = nodeProxy<ArkadikoDikoGuardianV11Contract>(
...
export const webArkadikoDikoGuardianV11Contract = (
    provider: BaseWebProvider
) => {
    const contract = webProxy<ArkadikoDikoGuardianV11Contract>(
        ArkadikoDikoGuardianV11Interface,
        provider
    );
    return contract;
