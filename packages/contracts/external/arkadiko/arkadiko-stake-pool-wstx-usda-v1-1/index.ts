  ...
  export const nodeArkadikoStakePoolWstxUsdaV11Contract = (provider: BaseNodeProvider) => {
    const contract = nodeProxy<ArkadikoStakePoolWstxUsdaV11Contract>(ArkadikoStakePoolWstxUsdaV11Interface, provider);
    return contract;
  };
  ...
  export const webArkadikoStakePoolWstxUsdaV11Contract = (provider: BaseWebProvider) => {
    const contract = webProxy<ArkadikoStakePoolWstxUsdaV11Contract>(ArkadikoStakePoolWstxUsdaV11Interface, provider);
    return contract;
  };
