...
export interface ArkadikoSwapV11Contract {
    ...
    getBalances: (
        tokenXTrait: string,
        tokenYTrait: string
    ) => Transaction<bigint[], ClarityTypes.Response<null, bigint>>;
    getData: (
        tokenXTrait: string,
        tokenYTrait: string,
        swapTokenTrait: string,
    ...
    getFeeToAddress: (
        ...
        ClarityTypes.Response<string | null, ClarityTypes.Response<null, bigint>>
    >;
    getFees: (
        tokenX: string,
        tokenY: string
    ) => Promise<
        ClarityTypes.Response<bigint[], ClarityTypes.Response<null, bigint>>
    >;
    getName: (
        tokenXTrait: string,
        tokenYTrait: string
    ) => Promise<
        ClarityTypes.Response<string, ClarityTypes.Response<null, bigint>>
    >;
    ...
    pairsDataMap: (key: { "token-x": string; "token-y": string }) => Promise<{
        "balance-x": bigint;
        "balance-y": bigint;
        "fee-balance-x": bigint;
        "fee-balance-y": bigint;
    ...
    pairsMap: (key: { "pair-id": bigint }) => Promise<{
        "token-x": string;
        "token-y": string;
    } | null>;
}
