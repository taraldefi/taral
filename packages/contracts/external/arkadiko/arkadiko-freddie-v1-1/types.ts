...
export interface ArkadikoFreddieV11Contract {
    ...
    finalizeLiquidation: (
        vaultId: number | bigint,
        leftoverCollateral: number | bigint,
        collType: string
    ) => Transaction<boolean, bigint>;
    getStabilityFeeForVault: (
        vaultId: number | bigint,
        collType: string
    ) => Transaction<bigint, bigint>;
    liquidate: (
    ...
    redeemTokens: (
        usdaAmount: number | bigint,
        dikoAmount: number | bigint
    ) => Transaction<boolean, bigint>;
    releaseStackedStx: (vaultId: number | bigint) => Transaction<boolean, bigint>;
    setBlockHeightLastPaid: (
        newBlockHeightLastPaid: number | bigint
    ) => Transaction<boolean, bigint>;
    setMaximumDebtSurplus: (
        newMaximumDebtSurplus: number | bigint
    ) => Transaction<boolean, bigint>;
    ...
    setStxRedeemable: (
        newStxRedeemable: number | bigint
    ) => Transaction<boolean, bigint>;
    ...
    withdrawLeftoverCollateral: (
        vaultId: number | bigint,
        reserve: string,
        ft: string,
        collType: string
    ) => Transaction<boolean, bigint>;
    getCollateralTokenForVault: (
        vaultId: number | bigint
    ) => Promise<ClarityTypes.Response<string, null>>;
    getCollateralTypeForVault: (
        vaultId: number | bigint
    ) => Promise<ClarityTypes.Response<string, null>>;
    ...
    stackingUnlockBurnHeight: (key: { "stacker-name": string }) => Promise<{
        height: bigint;
    } | null>;
}
