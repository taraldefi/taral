  ...
  export const nodeArkadikoVaultDataV11Contract = (provider: BaseNodeProvider) => {
    const contract = nodeProxy<ArkadikoVaultDataV11Contract>(ArkadikoVaultDataV11Interface, provider);
    return contract;
  };
  ...
  export const webArkadikoVaultDataV11Contract = (provider: BaseWebProvider) => {
    const contract = webProxy<ArkadikoVaultDataV11Contract>(ArkadikoVaultDataV11Interface, provider);
    return contract;
  };
