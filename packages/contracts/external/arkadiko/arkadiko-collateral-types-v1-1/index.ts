  ...
  export const nodeArkadikoCollateralTypesV11Contract = (provider: BaseNodeProvider) => {
    const contract = nodeProxy<ArkadikoCollateralTypesV11Contract>(ArkadikoCollateralTypesV11Interface, provider);
    return contract;
  };
  ...
  export const webArkadikoCollateralTypesV11Contract = (provider: BaseWebProvider) => {
    const contract = webProxy<ArkadikoCollateralTypesV11Contract>(ArkadikoCollateralTypesV11Interface, provider);
    return contract;
  };
