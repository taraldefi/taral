  ...
  export const nodeArkadikoVaultTraitV1Contract = (provider: BaseNodeProvider) => {
    const contract = nodeProxy<ArkadikoVaultTraitV1Contract>(ArkadikoVaultTraitV1Interface, provider);
    return contract;
  };
  ...
  export const webArkadikoVaultTraitV1Contract = (provider: BaseWebProvider) => {
    const contract = webProxy<ArkadikoVaultTraitV1Contract>(ArkadikoVaultTraitV1Interface, provider);
    return contract;
  };
