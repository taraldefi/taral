  ...
  export const nodeArkadikoAuctionEngineTraitV1Contract = (provider: BaseNodeProvider) => {
    const contract = nodeProxy<ArkadikoAuctionEngineTraitV1Contract>(ArkadikoAuctionEngineTraitV1Interface, provider);
    return contract;
  };
  ...
  export const webArkadikoAuctionEngineTraitV1Contract = (provider: BaseWebProvider) => {
    const contract = webProxy<ArkadikoAuctionEngineTraitV1Contract>(ArkadikoAuctionEngineTraitV1Interface, provider);
    return contract;
  };
