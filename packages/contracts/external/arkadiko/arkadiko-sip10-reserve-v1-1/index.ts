  ...
  export const nodeArkadikoSip10ReserveV11Contract = (provider: BaseNodeProvider) => {
    const contract = nodeProxy<ArkadikoSip10ReserveV11Contract>(ArkadikoSip10ReserveV11Interface, provider);
    return contract;
  };
  ...
  export const nodeArkadikoSip10ReserveV11Info: NodeContract<ArkadikoSip10ReserveV11Contract> = {
    ...
    contractFile: 'packages/clarity/contracts/external/arkadiko/arkadiko-sip10-reserve-v1-1.clar',
  };
  
  export const webArkadikoSip10ReserveV11Contract = (provider: BaseWebProvider) => {
    const contract = webProxy<ArkadikoSip10ReserveV11Contract>(ArkadikoSip10ReserveV11Interface, provider);
    return contract;
  };
