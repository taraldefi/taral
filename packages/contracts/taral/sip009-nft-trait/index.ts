  ...
  export const nodeSip009NftTraitContract = (provider: BaseNodeProvider) => {
    const contract = nodeProxy<Sip009NftTraitContract>(Sip009NftTraitInterface, provider);
    return contract;
  };
  ...
  export const webSip009NftTraitContract = (provider: BaseWebProvider) => {
    const contract = webProxy<Sip009NftTraitContract>(Sip009NftTraitInterface, provider);
    return contract;
  };
