  ...
  export const nodeTaralPurchaseOrderTraitContract = (provider: BaseNodeProvider) => {
    const contract = nodeProxy<TaralPurchaseOrderTraitContract>(TaralPurchaseOrderTraitInterface, provider);
    return contract;
  };
  ...
  export const nodeTaralPurchaseOrderTraitInfo: NodeContract<TaralPurchaseOrderTraitContract> = {
    ...
    contractFile: 'packages/clarity/contracts/taral/taral-purchase-order-trait.clar',
  };
  
  export const webTaralPurchaseOrderTraitContract = (provider: BaseWebProvider) => {
    const contract = webProxy<TaralPurchaseOrderTraitContract>(TaralPurchaseOrderTraitInterface, provider);
    return contract;
  };
