  ...
  export const nodeInsurancePoolAuditContract = (provider: BaseNodeProvider) => {
    const contract = nodeProxy<InsurancePoolAuditContract>(InsurancePoolAuditInterface, provider);
    return contract;
  };
  ...
  export const webInsurancePoolAuditContract = (provider: BaseWebProvider) => {
    const contract = webProxy<InsurancePoolAuditContract>(InsurancePoolAuditInterface, provider);
    return contract;
  };
