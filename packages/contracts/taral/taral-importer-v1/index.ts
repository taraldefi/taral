  ...
  export const nodeTaralImporterV1Contract = (provider: BaseNodeProvider) => {
    const contract = nodeProxy<TaralImporterV1Contract>(TaralImporterV1Interface, provider);
    return contract;
  };
  ...
  export const webTaralImporterV1Contract = (provider: BaseWebProvider) => {
    const contract = webProxy<TaralImporterV1Contract>(TaralImporterV1Interface, provider);
    return contract;
  };
