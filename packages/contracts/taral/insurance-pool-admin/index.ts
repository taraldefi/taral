  ...
  export const nodeInsurancePoolAdminContract = (provider: BaseNodeProvider) => {
    const contract = nodeProxy<InsurancePoolAdminContract>(InsurancePoolAdminInterface, provider);
    return contract;
  };
  ...
  export const webInsurancePoolAdminContract = (provider: BaseWebProvider) => {
    const contract = webProxy<InsurancePoolAdminContract>(InsurancePoolAdminInterface, provider);
    return contract;
  };
