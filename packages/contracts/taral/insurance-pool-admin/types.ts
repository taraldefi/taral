  ...
  delegateStx: (amountUstx: number | bigint, stacker: string, untilBurnHt: bigint | null, poxAddr: {
  "hashbytes": Buffer;
  "version": Buffer
    } | null, userAddr: {
  "hashbytes": Buffer;
  "version": Buffer
    }, lockingPeriod: number | bigint) => Transaction<{
  "lock-amount": bigint;
  "stacker": string;
  "unlock-burn-height": bigint
    }, bigint>;
  payin: (ustx: number | bigint, cycle: number | bigint) => Transaction<boolean, bigint>;
  stackAggregationCommit: (rewardCycle: number | bigint) => Transaction<boolean, bigint>;
  submitRewardTx: (block: {
  "height": bigint;
  "merkle-root": Buffer;
  "nbits": Buffer;
  "nonce": Buffer;
  ...
  submitUnauditedRewards: (amount: number | bigint, cycle: number | bigint) => Transaction<boolean, bigint>;
  ...
  getRewards: (user: string, cycle: number | bigint) => Promise<ClarityTypes.Response<bigint, bigint>>;
  ...
  errAllowContractCallerFailed: () => Promise<ClarityTypes.Response<null, bigint>>;
