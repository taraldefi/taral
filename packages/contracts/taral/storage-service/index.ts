  ...
  export const nodeStorageServiceContract = (provider: BaseNodeProvider) => {
    const contract = nodeProxy<StorageServiceContract>(StorageServiceInterface, provider);
    return contract;
  };
  ...
  export const webStorageServiceContract = (provider: BaseWebProvider) => {
    const contract = webProxy<StorageServiceContract>(StorageServiceInterface, provider);
    return contract;
  };
