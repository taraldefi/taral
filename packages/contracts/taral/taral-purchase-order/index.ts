  ...
  export const nodeTaralPurchaseOrderContract = (provider: BaseNodeProvider) => {
    const contract = nodeProxy<TaralPurchaseOrderContract>(TaralPurchaseOrderInterface, provider);
    return contract;
  };
  ...
  export const webTaralPurchaseOrderContract = (provider: BaseWebProvider) => {
    const contract = webProxy<TaralPurchaseOrderContract>(TaralPurchaseOrderInterface, provider);
    return contract;
  };
