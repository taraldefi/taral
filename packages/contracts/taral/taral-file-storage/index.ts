  ...
  export const nodeTaralFileStorageContract = (provider: BaseNodeProvider) => {
    const contract = nodeProxy<TaralFileStorageContract>(TaralFileStorageInterface, provider);
    return contract;
  };
  ...
  export const webTaralFileStorageContract = (provider: BaseWebProvider) => {
    const contract = webProxy<TaralFileStorageContract>(TaralFileStorageInterface, provider);
    return contract;
  };
