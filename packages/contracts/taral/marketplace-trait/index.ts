  ...
  export const nodeMarketplaceTraitContract = (provider: BaseNodeProvider) => {
    const contract = nodeProxy<MarketplaceTraitContract>(MarketplaceTraitInterface, provider);
    return contract;
  };
  ...
  export const webMarketplaceTraitContract = (provider: BaseWebProvider) => {
    const contract = webProxy<MarketplaceTraitContract>(MarketplaceTraitInterface, provider);
    return contract;
  };
