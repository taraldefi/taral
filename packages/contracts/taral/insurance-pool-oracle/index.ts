  ...
  export const nodeInsurancePoolOracleContract = (provider: BaseNodeProvider) => {
    const contract = nodeProxy<InsurancePoolOracleContract>(InsurancePoolOracleInterface, provider);
    return contract;
  };
  ...
  export const webInsurancePoolOracleContract = (provider: BaseWebProvider) => {
    const contract = webProxy<InsurancePoolOracleContract>(InsurancePoolOracleInterface, provider);
    return contract;
  };
