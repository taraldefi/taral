  ...
  export const nodeTaralPurchaseOrderV1Contract = (provider: BaseNodeProvider) => {
    const contract = nodeProxy<TaralPurchaseOrderV1Contract>(TaralPurchaseOrderV1Interface, provider);
    return contract;
  };
  ...
  export const nodeTaralPurchaseOrderV1Info: NodeContract<TaralPurchaseOrderV1Contract> = {
    ...
    contractFile: 'packages/clarity/contracts/taral/taral-purchase-order-v1.clar',
  };
  
  export const webTaralPurchaseOrderV1Contract = (provider: BaseWebProvider) => {
    const contract = webProxy<TaralPurchaseOrderV1Contract>(TaralPurchaseOrderV1Interface, provider);
    return contract;
  };
