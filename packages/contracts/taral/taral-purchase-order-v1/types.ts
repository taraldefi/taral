  ...
  createVault: (collateralStx: number | bigint, collateralBtc: number | bigint, loanAmount: number | bigint, duration: number | bigint) => Transaction<bigint, bigint>;
  ...
  repayLoan: (vaultId: number | bigint, repaymentAmount: number | bigint) => Transaction<bigint, bigint>;
  ...
  ERR_INSUFFICIENT_COLLATERAL: () => Promise<ClarityTypes.Response<null, bigint>>;
  ERR_INSUFFICIENT_REPAYMENT: () => Promise<ClarityTypes.Response<null, bigint>>;
  ERR_INVALID_AMOUNT: () => Promise<ClarityTypes.Response<null, bigint>>;
  ...
  ERR_NFT_TRANSFER_FAILED: () => Promise<ClarityTypes.Response<null, bigint>>;
  ...
  ERR_VAULT_NOT_UNDERCOLLATERALIZED: () => Promise<ClarityTypes.Response<null, bigint>>;
