  ...
  export const nodeImporterTraitContract = (provider: BaseNodeProvider) => {
    const contract = nodeProxy<ImporterTraitContract>(ImporterTraitInterface, provider);
    return contract;
  };
  ...
  export const webImporterTraitContract = (provider: BaseWebProvider) => {
    const contract = webProxy<ImporterTraitContract>(ImporterTraitInterface, provider);
    return contract;
  };
