  ...
  export const nodeClarityBitcoinContract = (provider: BaseNodeProvider) => {
    const contract = nodeProxy<ClarityBitcoinContract>(ClarityBitcoinInterface, provider);
    return contract;
  };
  ...
  export const webClarityBitcoinContract = (provider: BaseWebProvider) => {
    const contract = webProxy<ClarityBitcoinContract>(ClarityBitcoinInterface, provider);
    return contract;
  };
