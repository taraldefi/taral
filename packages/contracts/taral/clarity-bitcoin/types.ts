  ...
  "sequence": bigint
    ...
    }, bigint>) => Promise<ClarityTypes.Response<{
  "ctx": {
  "index": bigint;
  "txbuff": Buffer
    };
  ...
  readSlice: (data: Buffer, offset: number | bigint, size: number | bigint) => Promise<ClarityTypes.Response<Buffer, bigint>>;
  readSlice1: (input: {
  "data": Buffer;
  "index": bigint
    }) => Promise<Buffer>;
  ...
  verifyBlockHeader: (headerbuff: Buffer, expectedBlockHeight: number | bigint) => Promise<boolean>;
