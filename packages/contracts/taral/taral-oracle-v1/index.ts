  ...
  export const nodeTaralOracleV1Contract = (provider: BaseNodeProvider) => {
    const contract = nodeProxy<TaralOracleV1Contract>(TaralOracleV1Interface, provider);
    return contract;
  };
  ...
  export const webTaralOracleV1Contract = (provider: BaseWebProvider) => {
    const contract = webProxy<TaralOracleV1Contract>(TaralOracleV1Interface, provider);
    return contract;
  };
