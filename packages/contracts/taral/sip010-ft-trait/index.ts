  ...
  export const nodeSip010FtTraitContract = (provider: BaseNodeProvider) => {
    const contract = nodeProxy<Sip010FtTraitContract>(Sip010FtTraitInterface, provider);
    return contract;
  };
  ...
  export const webSip010FtTraitContract = (provider: BaseWebProvider) => {
    const contract = webProxy<Sip010FtTraitContract>(Sip010FtTraitInterface, provider);
    return contract;
  };
