  ...
  cancelAuction: (auctionId: number | bigint, nftAssetContract: string) => Transaction<boolean, bigint>;
  cancelFixedPriceListing: (listingId: number | bigint, nftAssetContract: string) => Transaction<boolean, bigint>;
  endAuction: (auctionId: number | bigint, nftAssetContract: string) => Transaction<{
  "auction-id": bigint;
  ...
  listFixedPrice: (nftAssetContract: string, nftAsset: {
  "price": bigint;
  "token-id": bigint
    }) => Transaction<bigint, bigint>;
  pauseContract: () => Transaction<boolean, bigint>;
  placeBid: (auctionId: number | bigint, bid: number | bigint) => Transaction<boolean, bigint>;
  purchaseFixedPriceListing: (listingId: number | bigint, recipient: string, nftAssetContract: string) => Transaction<boolean, bigint>;
  ...
  setWhitelisted: (assetContract: string, whitelisted: boolean) => Transaction<boolean, bigint>;
  startAuction: (nftAssetContract: string, nftAsset: {
  "end-block": bigint;
  ...
  errAssetContractNotWhitelisted: () => Promise<ClarityTypes.Response<null, bigint>>;
  ...
  errPaymentContractNotWhitelisted: () => Promise<ClarityTypes.Response<null, bigint>>;
