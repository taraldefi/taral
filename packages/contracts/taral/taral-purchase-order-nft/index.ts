  ...
  export const nodeTaralPurchaseOrderNftContract = (provider: BaseNodeProvider) => {
    const contract = nodeProxy<TaralPurchaseOrderNftContract>(TaralPurchaseOrderNftInterface, provider);
    return contract;
  };
  ...
  export const nodeTaralPurchaseOrderNftInfo: NodeContract<TaralPurchaseOrderNftContract> = {
    ...
    contractFile: 'packages/clarity/contracts/taral/taral-purchase-order-nft.clar',
  };
  
  export const webTaralPurchaseOrderNftContract = (provider: BaseWebProvider) => {
    const contract = webProxy<TaralPurchaseOrderNftContract>(TaralPurchaseOrderNftInterface, provider);
    return contract;
  };
