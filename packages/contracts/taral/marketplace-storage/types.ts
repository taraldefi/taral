  ...
  export interface MarketplaceStorageContract {
      addAuction: (auctionId: number | bigint, auction: {
  "end-block": bigint;
  "highest-bid": bigint;
  ...
  "auction-id": bigint;
  "bidder": string
    }, amount: number | bigint) => Transaction<boolean, null>;
  addCancelledAuction: (auctionId: number | bigint, auction: {
  "end-block": bigint;
  "highest-bid": bigint;
  "highest-bidder": string | null;
  "maker": string;
  ...
  addCancelledFixedPriceListing: (listingId: number | bigint, listing: {
  "maker": string;
  "nft-asset-contract": string;
  "price": bigint;
  "token-id": bigint
    }) => Transaction<boolean, null>;
  addCompletedAuction: (auctionId: number | bigint, auction: {
  "end-block": bigint;
  "highest-bid": bigint;
  "highest-bidder": string | null;
  "maker": string;
  ...
  addCompletedFixedPriceListing: (listingId: number | bigint, listing: {
  "maker": string;
  "nft-asset-contract": string;
  "price": bigint;
  "token-id": bigint
    }) => Transaction<boolean, null>;
  addFixedPriceListing: (listingId: number | bigint, listing: {
  "maker": string;
  "nft-asset-contract": string;
  "price": bigint;
  "token-id": bigint
  ...
  removeFixedPriceListing: (listingId: number | bigint) => Transaction<boolean, null>;
  setOwner: (newOwner: string) => Transaction<boolean, null>;
  setWhitelisted: (assetContract: string, whitelisted: boolean) => Transaction<boolean, null>;
  updateAuction: (auctionId: number | bigint, auction: {
  "end-block": bigint;
  "highest-bid": bigint;
  "highest-bidder": string | null;
  "maker": string;
  ...
  getPreviousBid: (auctionId: number | bigint, bidder: string) => Promise<bigint>;
  getWithdrawnBid: (auctionId: number | bigint, bidder: string) => Promise<bigint | null>;
