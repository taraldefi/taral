  ...
  export const nodeMarketplaceStorageContract = (provider: BaseNodeProvider) => {
    const contract = nodeProxy<MarketplaceStorageContract>(MarketplaceStorageInterface, provider);
    return contract;
  };
  ...
  export const webMarketplaceStorageContract = (provider: BaseWebProvider) => {
    const contract = webProxy<MarketplaceStorageContract>(MarketplaceStorageInterface, provider);
    return contract;
  };
