  ...
  export const nodeTaralExporterV1Contract = (provider: BaseNodeProvider) => {
    const contract = nodeProxy<TaralExporterV1Contract>(TaralExporterV1Interface, provider);
    return contract;
  };
  ...
  export const webTaralExporterV1Contract = (provider: BaseWebProvider) => {
    const contract = webProxy<TaralExporterV1Contract>(TaralExporterV1Interface, provider);
    return contract;
  };
