  ...
  export const nodeTaralImporterContract = (provider: BaseNodeProvider) => {
    const contract = nodeProxy<TaralImporterContract>(TaralImporterInterface, provider);
    return contract;
  };
  ...
  export const webTaralImporterContract = (provider: BaseWebProvider) => {
    const contract = webProxy<TaralImporterContract>(TaralImporterInterface, provider);
    return contract;
  };
