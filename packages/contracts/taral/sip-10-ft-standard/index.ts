  ...
  export const nodeSip10FtStandardContract = (provider: BaseNodeProvider) => {
    const contract = nodeProxy<Sip10FtStandardContract>(Sip10FtStandardInterface, provider);
    return contract;
  };
  ...
  export const webSip10FtStandardContract = (provider: BaseWebProvider) => {
    const contract = webProxy<Sip10FtStandardContract>(Sip10FtStandardInterface, provider);
    return contract;
  };
