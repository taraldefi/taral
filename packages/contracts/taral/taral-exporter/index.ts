  ...
  export const nodeTaralExporterContract = (provider: BaseNodeProvider) => {
    const contract = nodeProxy<TaralExporterContract>(TaralExporterInterface, provider);
    return contract;
  };
  ...
  export const webTaralExporterContract = (provider: BaseWebProvider) => {
    const contract = webProxy<TaralExporterContract>(TaralExporterInterface, provider);
    return contract;
  };
