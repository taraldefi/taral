  ...
  export const nodeExporterTraitContract = (provider: BaseNodeProvider) => {
    const contract = nodeProxy<ExporterTraitContract>(ExporterTraitInterface, provider);
    return contract;
  };
  ...
  export const webExporterTraitContract = (provider: BaseWebProvider) => {
    const contract = webProxy<ExporterTraitContract>(ExporterTraitInterface, provider);
    return contract;
  };
