  ...
  export const nodeInsurancePoolAuditCompactContract = (provider: BaseNodeProvider) => {
    const contract = nodeProxy<InsurancePoolAuditCompactContract>(InsurancePoolAuditCompactInterface, provider);
    return contract;
  };
  ...
  export const nodeInsurancePoolAuditCompactInfo: NodeContract<InsurancePoolAuditCompactContract> = {
    ...
    contractFile: 'packages/clarity/contracts/taral/insurance-pool-audit-compact.clar',
  };
  
  export const webInsurancePoolAuditCompactContract = (provider: BaseWebProvider) => {
    const contract = webProxy<InsurancePoolAuditCompactContract>(InsurancePoolAuditCompactInterface, provider);
    return contract;
  };
